...
- Deleting remote objects that no longer have a local counterpart — no sync/mirror semantics, matching ADR-0009's `copy`-only, never-destructive stance.
- Uploading to more than one remote at once.
