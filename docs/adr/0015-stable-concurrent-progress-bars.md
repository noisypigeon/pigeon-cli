...
- Terminal line-wrapping from long prefixes on narrow terminals — a plausible secondary contributor to bar-rendering glitches in general, but not what the observed pattern shows and not confirmed here; deferred unless it resurfaces after this fix.
